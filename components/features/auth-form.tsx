...
const inputClass =
  "w-full min-w-0 rounded-xl border border-white/10 bg-[#070a10] py-3 pl-10 pr-3.5 text-base sm:text-sm text-white placeholder:text-slate-600 transition-colors focus:border-[#00f5a0]/60 focus:outline-none focus:ring-2 focus:ring-[#00f5a0]/20";
